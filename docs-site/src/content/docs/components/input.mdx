...
![Text input](/skyscope-design-system/mockups/input.png)
...
<CodeBlock code={`use skyscope_design_system::components::text_input;
...
<CodeBlock code={`use skyscope_design_system::icons::{icon_text, ICON_SEARCH, ICON_CIRCLE_X};
